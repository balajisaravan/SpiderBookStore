...
<main>
    <table class="customer-table">
        ...
        <c:forEach items="${bookWarehouseDto}" var="bookWarehouseDto">
            <tr>
                <th id="bookid">${bookWarehouseDto.bookId}</th>
                ...
                <th><a href="editBook/${bookWarehouseDto.bookId}">edit</a></th>
                <th><a href="deleteBookInClientSide/${bookWarehouseDto.bookId}">delete</a></th>
            </tr>
        </c:forEach>
        </tbody>
    </table>
