...
<nav class="navbar navbar-expand-sm navbar-dark" data-id="web_navigation_bar">
    ...
    <div class="collapse navbar-collapse" id="web_navigation_bar_collapse">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="addBookInClientSide">AddBook</a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="getbookWarehouseDtoBySellerName">YoursBook</a>
            </li>
            ...
            <li class="nav-item">
                <c:if test="${pageContext.request.userPrincipal.name != null}">
                    <h2 class="nav-item" style="margin-left: 100px">
                        Hi : ${firstName}
                    </h2>
                </c:if>
            </li>
    ...
    <table class="customer-table">
        ...
        <c:forEach items="${bookWarehouseDto}" var="bookWarehouseDto">
            <tr>
                ...
                <th><a href="getbookWarehouseDtoById/${bookWarehouseDto.bookId}">buy</a></th>
            </tr>
        </c:forEach>
        </tbody>
    </table>
