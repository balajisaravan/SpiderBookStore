...
<div class="container">
    ...
    <c:url value="/updateBookInClientSide" var="updateBookInClientSide"/>
    <form:form action="${updateBookInClientSide}" method="post" modelAttribute="bookWarehouseDto">
    ...
    <table>
        ...
        <tr>
            <td>
                <div class="form-group">
                    <form:hidden path="sellerName" id="hb"/>
