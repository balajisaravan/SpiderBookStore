...
<div class="container">
    ...
    <c:url value="/updateCustomerDetails" var="updateCustomerDetails"/>
    <form:form action="${updateCustomerDetails}" method="post" modelAttribute="customerDto">
